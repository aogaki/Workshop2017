...
{
  fMessenger =
      new G4GenericMessenger(this, "/MyCommands/Primary/", "Beam control");

  // z position
  G4GenericMessenger::Command &ionCmd = fMessenger->DeclareMethod(
      "ionName", &MyPrimaryGeneratorAction::SetIonCmd, "Set the ion type");
